    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#b0642a] p-6 relative overflow-hidden selection:bg-[#FF9933]/30">
      ...
      <div className="relative z-10 w-full max-w-[280px]">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-[#FF9933]/20 py-3 text-[#FF9933]/70 hover:border-[#FF9933]/50 hover:text-[#FF9933] transition-all duration-500 text-[9px] uppercase tracking-[0.4em] font-sans font-bold"
        >
